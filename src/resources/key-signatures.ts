export const keySignatures: {
  ...
  // rootOffset = diatonic index of root letter in [C,D,E,F,G,A,B] (same convention as major keys)
  Am: { sharps: [], flats: [], rootOffset: 5 },
  Em: { sharps: [6], flats: [], rootOffset: 2 },
  Bm: { sharps: [6, 2], flats: [], rootOffset: 6 },
  "F#m": { sharps: [6, 2, 5], flats: [], rootOffset: 3 },
  "C#m": { sharps: [6, 2, 5, 1], flats: [], rootOffset: 0 },
  "G#m": { sharps: [6, 2, 5, 1, 4], flats: [], rootOffset: 4 },
  "D#m": { sharps: [6, 2, 5, 1, 4, 0], flats: [], rootOffset: 1 },
  "A#m": { sharps: [6, 2, 5, 1, 4, 0, 3], flats: [], rootOffset: 5 },

  Dm: { sharps: [], flats: [3], rootOffset: 1 },
  Gm: { sharps: [], flats: [3, 0], rootOffset: 4 },
  Cm: { sharps: [], flats: [3, 0, 4], rootOffset: 0 },
  Fm: { sharps: [], flats: [3, 0, 4, 1], rootOffset: 3 },
  Bbm: { sharps: [], flats: [3, 0, 4, 1, 5], rootOffset: 6 },
  Ebm: { sharps: [], flats: [3, 0, 4, 1, 5, 2], rootOffset: 2 },
  Abm: { sharps: [], flats: [3, 0, 4, 1, 5, 2, 6], rootOffset: 5 },
};
